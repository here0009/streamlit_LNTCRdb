...
type_info = st.selectbox(
    '**Is sample type information available(Cancer/Healthy)**',
    ('Yes', 'No'))
...
# if st.button('Show Example Data'):
    st.markdown(utils.small_font.format('Sample_ID and TCR features in the table below were required for Lung Cancer Model.'), unsafe_allow_html=True)
    ...
    # st.page_link("pages/TCR_Features_Calculation.py", label="TCR features calculation", icon="💻")
