...
# if st.button('Show Example Data'):
    ...
    st.markdown(utils.small_font.format('Example for input clonotype file:'), unsafe_allow_html=True)
    st.dataframe(test_data_tbl,column_config={},hide_index=True)
    st.markdown(utils.small_font.format('Clonotype files should be zipped and uploaded for TCR features calculation.'), unsafe_allow_html=True)
